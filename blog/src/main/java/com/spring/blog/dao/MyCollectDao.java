 ...
 */
public interface MyCollectDao extends BaseMapper<MyCollect> {
    /**
     ...
     * @return the list
     */
    List<MyCollect> selectAllByUserId(@Param("userId") int userId, @Param("isAsc") int isAsc);
    ...
    Integer hasCollect(MyCollect myCollect);
}