...
public class UserManage {
    ...
    @Log(logName = "封禁用户", businessType = BusinessType.DELETE, operatorType = OperatorType.MANAGE)
    ...
    @Log(logName = "恢复异常用户", businessType = BusinessType.UPDATE, operatorType = OperatorType.MANAGE)
    ...
    @Log(logName = "修改用户角色", businessType = BusinessType.UPDATE, operatorType = OperatorType.MANAGE)
