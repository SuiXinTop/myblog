...
import com.spring.rocket.dao.MyHistoryDao;
...
public class ViewConsumer implements RocketMQListener<MyHistory>, RocketMQPushConsumerLifecycleListener {
    private final MyBlogDao myBlogDao;
    private final MyHistoryDao myHistoryDao;

    @Override
    public void onMessage(MyHistory myHistory) {
        myBlogDao.addView(myHistory.getBlogId());
        myHistoryDao.insert(myHistory);
    }
